...
export class InformeDocentePage implements OnInit {
  ...
  asignaturas: Asignatura[] = [
    { nombre: 'Matemáticas I', seccion: 'A', horario: 'Lunes 08:00-10:00' },
    { nombre: 'Historia Universal', seccion: 'B', horario: 'Martes 10:00-12:00' },
    { nombre: 'Programación Básica', seccion: 'C', horario: 'Miércoles 14:00-16:00' },
    { nombre: 'Física Aplicada', seccion: 'D', horario: 'Jueves 16:00-18:00' },
    { nombre: 'Literatura Comparada', seccion: 'E', horario: 'Viernes 09:00-11:00' }
  ];
